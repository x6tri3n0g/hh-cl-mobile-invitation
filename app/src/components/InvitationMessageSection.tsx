...
export default function InvitationMessageSection() {
    return (
        <section className="animate-fade-up delay-200 rounded-[28px] border border-line bg-accent/10 px-6 py-7 shadow-[0_20px_40px_rgba(214,182,114,0.2)]">
            <h2 className="text-lg text-ink">마음을 전하는 글</h2>
